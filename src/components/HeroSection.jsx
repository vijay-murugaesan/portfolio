...
const HeroSection = () => {
  return (
    <div className="w-full min-h-screen overflow-x-hidden grid lg:grid-cols-[1fr_1fr] gap-[20px]">
      ...
      <div className="w-[90%] mx-auto py-[30px] flex flex-col items-start z-2">
        <a
          href="#contact"
        ...
        <p className="max-w-xl text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-start mt-[20px]">
          Experienced React js developer with 2 years of hands-on expertise in
